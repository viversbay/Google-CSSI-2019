...
shopping_list = ["apples", "bananas", "chips"]
...
while choice.lower() != "e":
    ...
    if (choice == "a"):
        ...
        print("Enter the item that you would like to remove")
        item = raw_input()
        shopping_list.remove(item)
    elif(choice == "c"):
        print("Enter the item you wish to check on the list: ")
        check = raw_input()
        for i in range(len(shopping_list)):
            if (check == shopping_list[i]):
                print(shopping_list[i]+" does exist")
                break
